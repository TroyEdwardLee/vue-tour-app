<template>
  <el-container>
    <keep-alive>
      <el-header class="top-header" style="height: 8rem;">
        <vue-particles
          color="#fff"
          :particleOpacity="0.7"
          :particlesNumber="60"
        ...
        <svg height="80" class="octicon-mark-github" viewBox="0 0 16 16" version="1.1" width="36" aria-hidden="true">
